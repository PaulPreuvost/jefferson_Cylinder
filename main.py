...
class Graphique:
    ...
    def __init__(self):
        ...
        self.window.configure(background='antique white')  # Couleur de fond de la fenêtre
        ...
        self.label = tk.Label(self.window, text=self.display_cylindre(), font=("Helvetica", 16), bg="antique white")
        self.label.pack(pady=20)

        # Frame pour les boutons de sélection de clé
        self.frame = tk.Frame(self.window, bg="antique white")
        self.frame.pack()

        # Boucle pour créer les boutons de sélection de clé
        for i in range(1, len(test_cylinder.dictionnaire) + 1):
            button = tk.Button(self.frame, text=str(i), width=5, height=2, command=lambda i=i: self.add_key(i), bg="grey", bd=1, font=("Helvetica", 10))
            button.pack(side=tk.LEFT, padx=5, pady=5)

        # Label pour afficher le texte "KEY"
        self.key_label = tk.Label(self.window, text="KEY", font=("Helvetica", 14), bg="antique white")
        self.key_label.pack(pady=10)

        # Frame pour le chiffrement du texte
        self.encrypt_frame = tk.Frame(self.window, bg="antique white")
        ...
        self.crypt_button = tk.Button(self.encrypt_frame, text="Chiffrer", width=10, command=self.encrypt, bg="grey", bd=1, font=("Helvetica", 12), fg="white smoke")
        self.crypt_button.pack(side=tk.LEFT, padx=5)

        # Frame pour le déchiffrement du texte
        self.decrypt_frame = tk.Frame(self.window, bg="antique white")
        ...
        self.decrypt_button = tk.Button(self.decrypt_frame, text="Déchiffrer", width=10, command=self.decrypt, bg="grey", bd=1, font=("Helvetica", 12), fg="white smoke")
        self.decrypt_button.pack(side=tk.LEFT, padx=5)

        # Label pour afficher le résultat
        self.result_label = tk.Label(self.window, text="RESULT", font=("Helvetica", 14), bg="antique white")
        self.result_label.pack(pady=10)

        self.reset_button = tk.Button(self.window, text="Reset", width=10, command=self.reset, font=("Helvetica", 16))
        self.reset_button.pack()

    def display_cylindre(self):
        cylindre = ""
        ...
        for i in range(1, len(test_cylinder.dictionnaire) + 1):
            ...
            cylindre += test_cylinder.dictionnaire[i]
...
if __name__ == "__main__":
    test_cylinder = JeffersonCylinder('txt/input.txt',
                                      8)  # Crée une instance de la classe main avec le fichier 'txt/input.txt' et 6
    # cylindres
